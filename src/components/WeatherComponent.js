        ...
        <form>
          <label>
            <input
              ...
              placeholder="Search"
              value={city}
              onChange={(e) => setCity(e.target.value)} // update the city state with the value from the input. e.target refers to the HTML element that triggered the event (the input in this case)
              id="input"
            />
          </label>
